...
class GPS(Thread):
    ...
    def __init__(self, front_hedge, rear_hedge, gopigo, mmPort, speed=300, q=None, debug_mode=False):
        ...
        self.__hedge = MarvelmindHedge(tty=self.mmPort, recieveUltrasoundPositionCallback=self.position_update)
        self.__hedge.start()
